...
class FaceRecognition():
    ...
    #after the face encodings have been saved 

    def postScan(self):
        
        self.classNames = np.loadtxt(self.namepath,dtype = str,ndmin=1)
    ...
    def fancyDraw(self,img, faceLoc,ratio,name,length=30,thickness=5):
        ...
        return img
    #store the first time a face is detected
    ...
    #compare face in img with known faces        
